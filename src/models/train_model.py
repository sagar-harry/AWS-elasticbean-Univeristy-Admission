...
def train_model(config):
    ...
    with open(config, "r") as my_file:
        ...
        my_dict["model_training"]["model_metrics"]["testing_r2_score"] = float(r2_score(y_test, model1.predict(X_test_standardized)))
        my_dict["model_training"]["model_metrics"]["training_r2_score"] = float(r2_score(y_train, model1.predict(X_train_standardized)))
